// Gemini prompts for transcription

export const GEMINI_RAW_TRANSCRIPTION_PROMPT = `The audio binary provided contains a voice note dictated by the user. Your task is to return a verbatim transcript of this content.
...
export const GEMINI_CLEANED_TRANSCRIPTION_PROMPT = `The audio binary provided contains a voice note dictated by the user. Your task is to return a lightly edited transcript of this content.
